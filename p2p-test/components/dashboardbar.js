              ...
              <nav className="mt-5 pt-8 flex-1" aria-label="Sidebar">
                <div className="px-2 space-y-1">
                  <a href="/" className="text-gray-900 group flex items-center px-2 py-2 text-sm font-medium rounded-md">
                    ...
                    <p className="overflow-hidden text-gray-900">
                    My Profile
                    </p>
                  </a>

                  <a href="/" className="text-gray-600 hover:bg-gray-50 hover:text-gray-900 group flex items-center px-2 py-2 text-sm font-medium rounded-md">
                   <svg className="text-gray-400 mr-3 group-hover:text-gray-500 h-6 w-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
