...
<aside className="h-full right-0 w-64 relative border-l-2  bg-red border-gray-200">
  ...
  <div className="hidden sm:block">
    <div className="border-b border-gray-200">
      <nav className="-mb-px flex items-center justify-center space-x-8" aria-label="Tabs">
        
        <p onClick={() => setTab(true)} className={`flex flex-row border-transparent text-gray-500 hover:text-gray-700 ${tab? "border-blue-300" : "hover:border-gray-300"} py-4 px-1 border-b-2 font-medium  text-base`}>
         <svg className="pr-2 h-6" viewBox="0 0 20 20">
        ...
        <p onClick={() => setTab(false)} className={`flex flex-row border-transparent text-gray-500 hover:text-gray-700  ${tab? "hover:border-gray-300" : "border-blue-300"} whitespace-nowrap py-4 px-1 border-b-2 font-medium text-base`}>
         <svg className="pr-2 h-6" viewBox="0 0 20 20">
