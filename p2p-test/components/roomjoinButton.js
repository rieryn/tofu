...
export default function RoomJoinButton(props){
  ...
  return (
<a href={`/rooms?room=${props.roomid}`} className="w-56 pt-2 border border-gray-300 text-gray-600 hover:bg-gray-50 hover:text-gray-900 group flex items-center px-2 py-2 text-sm font-medium rounded-md">
