  ...
  <div className="hidden sm:block">
    <div className="border-b border-gray-200">
      <nav className="-mb-px flex items-center justify-center space-x-8" aria-label="Tabs">
        ...
        <p onClick={() => setTab(true)}
         className={`flex flex-row border-transparent text-gray-500 hover:text-gray-700 ${tab? "border-blue-300" : "hover:border-gray-300"} py-4 px-1 border-b-2 font-medium  text-base`}>
        ...
        <p onClick={() => setTab(false)} 
        className={`flex flex-row border-transparent text-gray-500 hover:text-gray-700  ${tab? "hover:border-gray-300" : "border-blue-300"} whitespace-nowrap py-4 px-1 border-b-2 font-medium text-base`}>
         <svg className="pr-2 h-6" viewBox="0 0 20 20">
...
{tab ? 
  <div>
      ...
      <textarea className = "absolute bottom-10 leading-relaxed p-2  h-24 resize-none rounded-lg flex  justify-self-start  w-56 border-2 border-blue-100 focus:outline-none focus:border-blue-400"
