...
export default function Component() {
 ...
 :
          ...
          {suggestions.map(i =>(<a key={i.coursecode}  href = {`course_search_results?q=${i.coursecode}`}><p className=" hover:bg-red-100 p-2 truncate text-left">{i.coursecode} {i.coursename}</p></a>))}
