        ...
        <div className="flex-1 relative z-0 flex overflow-hidden">
          <main className="flex-1 relative z-0 overflow-y-auto focus:outline-none">
            <div className="absolute inset-0 py-6 px-4 sm:px-6 lg:px-8">
                <div className="bg-red-50 p-12 flex items-center border shadow rounded-lg max-w-xl">
...
<div className = "mt-5 max-w-6xl grid gap-5 sm:grid-cols-1 md:grid-cols-4">
<div className="relative max-w-xs  w-48 justify-left items-left text-left  bg-white pt-5 px-4 pb-12 shadow rounded-lg overflow-hidden">
          ...
          <dd className="ml-16 pb-6 flex  items-baseline sm:pb-7">
            ...
            <div className="absolute bottom-0 inset-x-0 bg-gray-50 px-4 py-4 sm:px-6">
              <div className="text-sm">
                <p className="font-sm"> Details: 1/4, 2/3 github</p>
              </div>
            </div>
          </dd>
